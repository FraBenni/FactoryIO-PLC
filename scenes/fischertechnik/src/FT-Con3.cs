...
namespace FT3
{
	...
	public class FT_Con3
	{
		...
		public MemoryBit C3_motor;
		public MemoryBit M2_motor;
		...
		private void SetOutputs()
		{
			...
			C3_motor.Value = (iec_type.iec_uint8 == 0) ? true : false;

			iec_type = read_variable(0, 1);
			M2_motor.Value = (iec_type.iec_uint8 == 0) ? true : false;
